...
class TestSnakeMovementPlanner(unittest.TestCase):
    ...
    def test_planMovement_simpleAngle(self):
        ...
        self.assertEqual(2, len(moves))
        self.assertEqual(270, moves[0].angleInDegrees)
        self.assertEqual(1, moves[1].distanceInCentimeters)
    ...
    def test_planMovement_complexMovement_1(self):
        ...
        self.assertAlmostEqual(360 - math.degrees(math.acos(2/math.sqrt(1229))), moves[0].angleInDegrees, delta=delta)
        ...
        self.assertAlmostEqual(360 - math.degrees(math.acos(-13/math.sqrt(218))), moves[4].angleInDegrees, delta=delta)
        self.assertAlmostEqual(math.sqrt(109), moves[5].distanceInCentimeters, delta=delta)
        self.assertAlmostEqual(360 - math.degrees(math.acos(-15/math.sqrt(3706))), moves[6].angleInDegrees, delta=delta)
    ...
    def test_planMovement_fieldTest_1(self):
        ...
        self.assertAlmostEqual(270, moves[1].angleInDegrees, delta=delta)
