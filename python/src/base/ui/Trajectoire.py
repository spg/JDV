...
class Trajectoire():
    def __init__(self,Departx,Departy,Finx,Finy):
        ...
        self.x2=160
        self.y2=120
        self.Ox21=40+self.x2
        self.Ox22=40+self.x2
        self.Ox23=self.x2-20
        self.Ox24=self.x2-20
        self.Oy21=40+self.y2
        self.Oy22=self.y2-20
        self.Oy23=40+self.y2
        self.Oy24=self.y2-20
        self.Ox11=40+self.x1
        self.Ox12=40+self.x1
        self.Ox13=self.x1-20
        self.Ox14=self.x1-20
        self.Oy11=40+self.y1
        self.Oy12=self.y1-20
        self.Oy13=40+self.y1
